...
function populateFAQSection() {
    ...
    applicationData.faqCategories.forEach(category => {
...
function toggleBlog(button) {
    ...
    const blogFull = blogCard.querySelector('.blog-full');
    const isExpanded = !blogFull.classList.contains('hidden');
    ...
    if (isExpanded) {
        ...
        setTimeout(() => {
            blogFull.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
        }, 100);
    }
}
